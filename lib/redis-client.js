...
class RedisClient {
    constructor(logger, params = {}) {
        ...
        this.client = redis.createClient(this._redisParams.port, this._redisParams.host, {
    ...
    subscribe(channel, cb) {
        return new Promise((resolve, reject) => {
            ...
            this.client.psubscribe(channel, (err, result) => {
                if (result) {
                    resolve()
                } else {
                    reject(err)
    ...
    publishMessage(channel, message) {
        return new Promise((resolve, reject) => {
            this.client.publish(channel, message, (err, result) => {
                if (err) reject(err)
